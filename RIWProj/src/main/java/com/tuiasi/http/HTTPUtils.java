...
public class HTTPUtils {
    ...
    @SneakyThrows
    public static void createRequest(String path, String domain, int port) {
    ...
    @SneakyThrows
    private static void writeHTMLBody(String path, String domain, String response, String headers) {
    ...
    @SneakyThrows
    private static BufferedReader sendRequest(String domain, int port, String request) {
